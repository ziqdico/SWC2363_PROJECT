...
<div class="header">
    <div class="header-top">
        <div class="wrap">
            <div class="h-logo">
                <a href="index.php"><img src="images/NEW LOGO 1.jpg" alt="Logo Image Here" /></a>
            </div>
            <div class="nav-wrap">
                <ul class="group" id="example-one">
                    ...
                    <li>
                        ...
                        if (isset($_SESSION['user'])) {
                            $us = mysqli_query($con, "SELECT * FROM users WHERE user_id='" . $_SESSION['user'] . "'");
...
function validateSearch() {
    var searchField = $('#search111').val().trim();
    if (searchField === "") {
